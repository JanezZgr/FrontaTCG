...
{
    [DbContext(typeof(FrontaTCGDbContext))]
    [Migration("20230602072732_AddedCards")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("FrontaTCG.Cards.Card", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("CostManpower")
                        .HasColumnType("integer");

                    b.Property<int>("CostMaterial")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("FrontaTCG.Cards.CardAbility", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.Property<byte>("ActivationCount")
                        .HasColumnType("smallint");

                    b.Property<int>("ActivationRange")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppCardAbilities", (string)null);
                });

            modelBuilder.Entity("FrontaTCG.Cards.UnitCard", b =>
                {
                    b.Property<Guid>("Id")
                        .HasColumnType("uuid");
                    ...
                    b.Property<int>("DmgAir")
                        .HasColumnType("integer");

                    b.Property<int>("DmgArmored")
                        .HasColumnType("integer");

                    b.Property<int>("DmgStructure")
                        .HasColumnType("integer");

                    b.Property<int>("DmgUnarmored")
                        .HasColumnType("integer");
                    ...
                    b.ToTable("AppUnitCards", (string)null);
                });
            ...
            modelBuilder.Entity("FrontaTCG.Cards.Card", b =>
                {
                    b.HasOne("FrontaTCG.Cards.CardAbility", "Ability1")
                        .WithMany()
            ...
            modelBuilder.Entity("FrontaTCG.Cards.UnitCard", b =>
                {
                    b.HasOne("FrontaTCG.Cards.CardAbility", "Ability2")
                        .WithMany()
                        .HasForeignKey("Ability2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("FrontaTCG.Cards.Card", "Card")
                        .WithMany()
